...
public class TodoControllerTest {
    ...
    @Test
    void should_response_404_when_update_non_existing_todo() throws Exception {
        String requestBody = """
                {
                    "text": "Buy snacks",
                    "done": true
    ...
    @Test
    void should_response_422_when_update_todo_with_empty_object() throws Exception {
        Todo existingTodo = new Todo("123", "Buy milk", false);
        todoRepository.save(existingTodo);
    ...
    @Test
    void should_response_204_when_delete_existing_todo() throws Exception {
        Todo existingTodo = new Todo("123", "Buy milk", false);
        todoRepository.save(existingTodo);
    ...
    @Test
    void should_response_404_when_delete_non_existing_todo() throws Exception {
